// Immutable identity and business-date helpers for the Sales Orders module.
// All entity keys are UUIDs produced by crypto.randomUUID; user-visible
// numbers (AIC-SO-YYYY-NNNN) are allocated by the sequence tab under the lock.
